...
function searchTodos(searchValue) {
  const todos = document.querySelectorAll(".todo"); // Seleciona todas as tarefas

  todos.forEach((todo) => {
    const todoTitle = todo.querySelector("h3").innerText.toLowerCase(); // Pega o texto da tarefa

    // Verifica se o texto da tarefa inclui o valor da pesquisa
...
// Evento de input para capturar a pesquisa
